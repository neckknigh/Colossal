 ...
 * para la tabla ComponenteHasTag
 *
 * @author Jhon Vargas
 */
@Stateless
public class ComponenteHasTagDAO extends AbstractDAO<ComponenteHasTag> {
    ...
    /**
     * Constructor vacío de la clase ComponenteHasTagDAO
     */
    public ComponenteHasTagDAO() {
        super(ComponenteHasTag.class);
    }
    ...
    public boolean removeAll(Componente componente) {
        boolean exito = false;
        try {
            this.em.createNamedQuery("ComponenteHasTag.removeAll").setParameter("componente", componente).executeUpdate();
            exito = true;
